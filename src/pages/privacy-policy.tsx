    ...
    <>
      <div className="page">
        ...
        <div className="container">
          <div className="section about align-left">
            <div className="fw">
              <div className="row">
                <div className="col col-m-12 col-t-12 col-d-12">
                  <div>
                    ...
                    <ul>
                      ...
                      <li>
                        <p>
                          <strong>Website</strong> refers to John Tagudin,
                          accessible from{" "}
                          <a
                            href="https://johntagudin.com"
                    ...
                    <ul>
                      <li>By email: info@johntagudin.com</li>
                    </ul>
                  </div>
                </div>
              </div>
